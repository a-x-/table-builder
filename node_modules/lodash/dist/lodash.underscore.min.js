...
(function () {
    ...
    var Cr = Fr || function (n) {
        ...
        for (t in n)if (Nr.call(n, t) && r(n[t], t, n) === er) {
            break;
        }
        return n
    };
    ...
    u.after = function (n, r) {
        ...
        for (var n = arguments, r = n.length; r--;)if (!A(n[r])) {
            throw new TypeError;
        }
        return function () {
        ...
        var e = n ? n.length : 0;
        for (typeof t == "number" && (e = (0 > t ? Mr(0, e + t) : $r(t, e - 1)) + 1); e--;)if (n[e] === r) {
            return e;
        }
        return-1
