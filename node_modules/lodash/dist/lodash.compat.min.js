...
(function () {
    ...
    function g(e) {
        ...
        function at(n, t, e, r, u, o) {
            ...
            for (l = !u, u || (u = i()), o || (o = i()), s = u.length; s--;)if (u[s] == n) {
                return o[s] == t;
            }
            var h = 0, a = true;
            if (u.push(n), o.push(t), p) {
                if (s = n.length, h = t.length, (a = h == s) || r) {
                    for (; h--;)if (p = s, g = t[h], r) {
        ...
        return v.after = function (n, t) {
            ...
            for (var n = arguments, t = n.length; t--;)if (!jt(n[t])) {
                throw new le;
            }
            return function () {
            ...
            n:for (; ++h < v;) {
                var m = a[0], g = f[h];
                if (0 > (m ? t(m, g) : l(s, g))) {
                    for (r = u, (m || s).push(g); --r;)if (m = a[r], 0 > (m ? t(m, g) : l(e[r], g))) {
                        continue n;
                    }
                    y.push(g)
                }
            ...
            for (t = v.createCallback(t, e, 3); ++r < u;)if (t(n[r], r, n)) {
                return r;
            }
            return-1
            ...
            var r = n ? n.length : 0;
            for (t = v.createCallback(t, e, 3); r--;)if (t(n[r], r, n)) {
                return r;
            }
            return-1
            ...
            var r = n ? n.length : 0;
            for (typeof e == "number" && (r = (0 > e ? Be(0, r + e) : Pe(e, r - 1)) + 1); r--;)if (n[r] === t) {
                return r;
            }
            return-1
