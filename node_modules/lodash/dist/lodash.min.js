...
(function () {
    ...
    function s(e) {
        ...
        function _(n, t, e) {
            ...
            for (var i = arguments, a = 0, f = typeof e == "number" ? 2 : i.length; ++a < f;)if ((u = i[a]) && V[typeof u]) {
        ...
        return J.after = function (n, t) {
            ...
            for (var n = arguments, t = n.length; t--;)if (!dt(n[t])) {
                throw new ie;
            }
            return function () {
            ...
            n:for (; ++h < g;) {
                var m = i[0], v = p[h];
                if (0 > (m ? t(m, v) : f(s, v))) {
                    for (r = u, (m || s).push(v); --r;)if (m = i[r], 0 > (m ? t(m, v) : f(e[r], v))) {
                        continue n;
                    }
                    y.push(v)
                }
            ...
            var r = -1, u = n ? n.length : 0;
            for (t = J.createCallback(t, e, 3); ++r < u;)if (t(n[r], r, n)) {
                return r;
            }
            return-1
            ...
            var r = n ? n.length : 0;
            for (t = J.createCallback(t, e, 3); r--;)if (t(n[r], r, n)) {
                return r;
            }
            return-1
            ...
            var r = n ? n.length : 0;
            for (typeof e == "number" && (r = (0 > e ? Ie(0, r + e) : Se(e, r - 1)) + 1); r--;)if (n[r] === t) {
                return r;
            }
            return-1
